...
function DeckCard({ card, addCardToDeck, removeCardFromDeck, onDashboard }) {
  return (
    <div className="deckCard">
      ...
      <div>
        {onDashboard === true ? null : <><button className="add" type="button" onClick={() => { addCardToDeck(card) }}>+</button>
